...
import {
  attachConfiguredVisualMeshes,
  attachObjectToGroup,
  buildChildVisibilityMeta,
  buildFloorRoomsMap,
  getSceneObjectMeshNames,
  setBuildingVisualState,
  setSceneObjectsVisibility as setSceneObjectsVisibilityForMode,
} from "./core/sceneGraph.js";
import {
  animateBreathingRooms as animateBreathingRoomsEffect,
  animateHoverPulses as animateHoverPulsesEffect,
  clearRoomHighlights as clearRoomHighlightsEffect,
  highlightRoom as highlightRoomEffect,
  setHoverPulseState as setHoverPulseStateEffect,
  setRoomHoverBreathingState as setRoomHoverBreathingStateEffect,
  startRoomBreathing as startRoomBreathingEffect,
  tintMaterialToMilky,
} from "./core/visualEffects.js";
...
function setHoverPulseState(clickable, active) {
  setHoverPulseStateEffect(hoverPulseStates, clickable, active);
}

function setRoomHoverBreathingState(clickable, active) {
  setRoomHoverBreathingStateEffect(breathingRoomStates, clickable, active);
}
...
function setSceneObjectsVisibility(mode = "overview") {
  setSceneObjectsVisibilityForMode(sceneObjectStates, mode);
}
...
function startRoomBreathing(mesh) {
  startRoomBreathingEffect(breathingRoomStates, mesh);
}

function animateBreathingRooms(time) {
  animateBreathingRoomsEffect(time, {
    breathingRoomStates,
    highlightedRoomsStates,
  });
}
...
function animateHoverPulses(time) {
  animateHoverPulsesEffect(time, hoverPulseStates);
}
